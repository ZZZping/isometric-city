...
import { 
  FIREWORK_BUILDINGS, FIREWORK_COLORS, FIREWORK_PARTICLE_COUNT,
  FIREWORK_PARTICLE_SPEED, FIREWORK_PARTICLE_MAX_AGE, FIREWORK_LAUNCH_SPEED,
  FIREWORK_SPAWN_INTERVAL_MIN, FIREWORK_SPAWN_INTERVAL_MAX,
  FIREWORK_SHOW_DURATION, FIREWORK_SHOW_CHANCE
} from '../constants';
...
export function useFireworks({ worldStateRef, isMobile }: UseFireworksOptions) {
  ...
  const findFireworkBuildingsCallback = useCallback(() => {
