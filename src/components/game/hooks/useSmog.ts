...
import { 
  SMOG_PARTICLE_MAX_AGE, SMOG_PARTICLE_MAX_AGE_MOBILE,
  SMOG_SPAWN_INTERVAL_MEDIUM, SMOG_SPAWN_INTERVAL_LARGE,
  SMOG_SPAWN_INTERVAL_MOBILE_MULTIPLIER, SMOG_DRIFT_SPEED,
  SMOG_RISE_SPEED, SMOG_MAX_ZOOM, SMOG_FADE_ZOOM, SMOG_BASE_OPACITY,
  SMOG_PARTICLE_SIZE_MIN, SMOG_PARTICLE_SIZE_MAX, SMOG_PARTICLE_GROWTH,
  SMOG_MAX_PARTICLES_PER_FACTORY, SMOG_MAX_PARTICLES_PER_FACTORY_MOBILE
} from '../constants';
import { gridToScreen } from '../utils';
import { findSmogFactories } from '../gridFinders';
import { TILE_WIDTH, TILE_HEIGHT } from '../types';

export type UseSmogOptions = {
  worldStateRef: React.MutableRefObject<WorldRenderState>;
  gridVersionRef: React.MutableRefObject<number>;
  isMobile: boolean;
};

export function useSmog({ worldStateRef, gridVersionRef, isMobile }: UseSmogOptions) {
