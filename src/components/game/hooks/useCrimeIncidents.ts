...
import { WorldRenderState, TILE_WIDTH, TILE_HEIGHT } from '../types';
...
export type UseCrimeIncidentsOptions = {
  worldStateRef: React.MutableRefObject<WorldRenderState>;
  policeServices: number[][];
  population: number;
};

export function useCrimeIncidents({ worldStateRef, policeServices, population }: UseCrimeIncidentsOptions) {
  ...
  }, [worldStateRef, policeServices, population]);
