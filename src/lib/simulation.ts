...
// Water body names
const LAKE_NAMES = [
  'Pine Lake', 'Crystal Lake', 'Emerald Lake', 'Silver Lake', 'Blue Lake',
  'Sunset Lake', 'Moonlight Lake', 'Whisper Lake', 'Tranquil Lake', 'Serene Lake',
  'Mountain Lake', 'Forest Lake', 'Valley Lake', 'Riverside Lake', 'Harbor Lake',
  'Clearwater Lake', 'Deep Lake', 'Shallow Lake', 'Mirror Lake', 'Reflection Lake',
  'Dawn Lake', 'Dusk Lake', 'Twilight Lake', 'Starlight Lake', 'Aurora Lake',
  'Rainbow Lake', 'Golden Lake', 'Diamond Lake', 'Pearl Lake', 'Sapphire Lake',
  'Maple Lake', 'Oak Lake', 'Cedar Lake', 'Willow Lake', 'Birch Lake',
  'Spring Lake', 'Summer Lake', 'Autumn Lake', 'Winter Lake', 'Eternal Lake',
];
...
const OCEAN_NAMES = [
  ...
  'Dawn Sea', 'Dusk Sea', 'Twilight Sea', 'Starlight Sea', 'Moonlight Sea',
  'Storm Sea', 'Calm Sea', 'Tranquil Sea', 'Serene Sea', 'Peaceful Sea',
  'Ancient Sea', 'Eternal Sea', 'Timeless Sea', 'Mystic Sea', 'Legendary Sea',
];

// City names for adjacent cities
const CITY_NAMES = [
  'Springfield', 'Riverside', 'Hillcrest', 'Oakwood', 'Greenfield',
  'Sunset Valley', 'Maple Grove', 'Cedar Falls', 'Pine Ridge', 'Willow Creek',
  'Millbrook', 'Fairview', 'Westfield', 'Eastwood', 'Northbrook',
  'Southport', 'Harborview', 'Bayview', 'Lakeside', 'Seaside',
  'Mountain View', 'Valley Falls', 'Rockville', 'Stonebridge', 'Ironwood',
  'Brighton', 'Summit', 'Ridgewood', 'Highland', 'Lowland',
  'Newport', 'Portsmouth', 'Harbor City', 'Bay City', 'Coast City',
  'Midtown', 'Uptown', 'Downtown', 'Central City', 'Metro City',
];
...
function generateLakes(grid: Tile[][], size: number, seed: number): WaterBody[] {
  ...
  for (const center of selectedCenters) {
    ...
    // Add to water bodies list with a random name
...
function generateOceans(grid: Tile[][], size: number, seed: number): WaterBody[] {
  ...
  // Determine which edges have oceans (1-4 edges)
